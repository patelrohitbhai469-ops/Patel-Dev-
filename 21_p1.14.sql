DECLARE
    ...
    v_plan_idx      NUMBER       := MOD(v_roll_no, 4) + 1; -- Evaluates to 2
    v_plan_price    NUMBER;
...
=========================================
          JIO MOBILE RECHARGE            
            TAX INVOICE                  
=========================================
Customer Name       : Patel Dev
Roll Number         : 21
Plan Selected       : 28 Days High-Speed Pack
-----------------------------------------
Base Plan Price     : Rs.    299.00
GST @ 18%           : Rs.     53.82
-----------------------------------------
Total Payable       : Rs.    352.82
-----------------------------------------
