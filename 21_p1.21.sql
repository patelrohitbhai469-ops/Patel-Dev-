DECLARE
    ...
    v_emp_id        NUMBER       := 100 + MOD(v_roll_no, 20); -- Evaluates to 101
...
+----------------------------------------------------+
| Student Name : Patel Dev (Roll: 21)                |
| Employee ID  : 101                                 |
...
| EARNINGS                      AMOUNT (Rs.)         |
+----------------------------------------------------+
| Basic Salary                             17,000.00 |
| Dearness Allowance (DA 40%)               6,800.00 |
| House Rent Allowance (HRA 20%)            3,400.00 |
+----------------------------------------------------+
| GROSS EARNINGS                           27,200.00 |
+----------------------------------------------------+
| DEDUCTIONS                    AMOUNT (Rs.)         |
+----------------------------------------------------+
| Provident Fund (PF 12%)                   2,040.00 |
+----------------------------------------------------+
| NET PAYABLE                              25,160.00 |
+----------------------------------------------------+
'''