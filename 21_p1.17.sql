DECLARE
    ...
    v_p             NUMBER       := (v_roll_no * 10000) + 50000; -- Evaluates to 2,60,000
...
Roll Number    : 21
-----------------------------------------
Loan Principal : Rs.2,60,000.00
Annual Rate    : 9%
Tenure (Years) : 5 Years (60 Months)
-----------------------------------------
Monthly EMI    : Rs.5,396.06
Total Payment  : Rs.3,23,763.60
Total Interest : Rs.63,763.60
-----------------------------------------
Interest Share : 19.69% of total payment is interest
========================================='''
